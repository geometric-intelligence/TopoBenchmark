...
python train.py dataset=NCI1 model=gin model.optimizer.lr=0.001 model.optimizer.weight_decay=0 model.backbone.hidden_channels=16 model.backbone.num_layers=4 dataset.parameters.batch_size=32 dataset.parameters.data_seed=0,2,3,4,5,7,8,9 model.backbone.dropout=0 logger.wandb.project=NCI1_dataset --multirun
