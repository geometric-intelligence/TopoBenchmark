...
from topobenchmarkx.models.encoders.encoder import AbstractFeatureEncoder
...
class AllCellFeatureEncoder(AbstractFeatureEncoder):
    ...
    Args:
        ...
        out_channels (list[int]): Output dimensions for the features.
        proj_dropout (float, optional): Dropout for the BaseEncoders. (default: 0)
    ...
    def forward(
        ...
        Returns:
            torch_geometric.data.Data: Output data object with updated x_{i} features.
        """
...
class BaseEncoder(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor, batch: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            ...
            batch (torch.Tensor): The batch vector which assigns each element to a specific example.
        Returns:
