"""CODE IMPORTED FROM https://github.com/Blealtan/efficient-kan."""
...
class EfficientKANLinear(torch.nn.Module):
    ...
    scale_base : float, optional
        Scale of the base, by default 1.0.
    scale_spline : float, optional
        Scale of the spline, by default 1.0.
    enable_standalone_scale_spline : bool, optional
        Enable standalone scale spline, by default True.
    ...
    **kwargs : dict, optional
    ...
    def scaled_spline_weight(self):
        """
        Scaled spline weight.

        Returns
        -------
        torch.Tensor
            Scaled spline weight tensor.
        """
    ...
    def forward(self, x: torch.Tensor):
        """
        Forward pass of the KAN linear layer.
    ...
    def regularization_loss(
        ...
        regularize_activation : float, optional
            Regularization weight for the activation, by default 1.0.
        regularize_entropy : float, optional
            Regularization weight for the entropy, by default 1.0.
    ...
    **kwargs : dict, optional
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for in_features, out_features in zip(  # noqa: RUF007
